...
function rmake_neuron_output(outobject, node, recfile)

if ({mynode}=={node})

create asc_file /{outobject}.output

setfield /{outobject}.output filename {recfile} append 0 flush 1 leave_open 0

useclock /{outobject}.output 1

addmsg {outobject}/soma /{outobject}.output SAVE Vm
